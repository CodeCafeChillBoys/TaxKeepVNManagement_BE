...
namespace TaxKeepVN.Infrastructure.Migrations
{
    ...
    [Migration("20260921043656_AddIsNotReimbursedToDocuments")]
    partial class AddIsNotReimbursedToDocuments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaxKeepVN.Domain.Entities.DependentDocument", b =>
                {
                    ...
                    b.HasIndex("DependentId")
                        .HasDatabaseName("idx_dependent_documents_dependent_id");
            ...
            modelBuilder.Entity("TaxKeepVN.Domain.Entities.Document", b =>
                {
                    ...
                    b.Property<bool?>("IsNotReimbursed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_not_reimbursed");
